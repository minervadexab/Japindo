...
<head>
    ...
    <style>
        ...
        header {
        color: #000000; /* Ganti warna teks sesuai preferensi Anda */
        text-align: center;
        padding: 20px; /* Mengganti padding menjadi 20px untuk tampilan lebih baik */
        background-color: #3652ad; /* Ganti warna latar belakang sesuai preferensi Anda */
        ...
        header:hover {
            background-color: #ffff; /* Ganti warna latar belakang saat hover sesuai preferensi Anda */
        }
...
if (isset($_POST['save'])) {
  ...
  // up gambar
    ...
    if (!in_array($ext, $ekstensi)) {
        echo "<script>alert('Gambar tidak sesuai dengan format!')</script>";
        header("location: membuatmenu.php");
    } else {
        if ($ukuran < 1044070) {
            $xx = $rand . '.' . $ext;
            ...
            $insert_data = mysqli_query($koneksi, "INSERT INTO `menu` (`nama`, `hari`, `deskripsi`, `gambar`) VALUES ('$nama','$hari','$deskripsi', '$xx')");
            if ($insert_data) {
                $got = "menu telah ditambahkan";
                $_SESSION['success_message'] = $got;
                header("location:?3alert=berhasil");
                exit;
            } else {
